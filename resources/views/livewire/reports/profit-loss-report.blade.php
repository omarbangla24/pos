...
<div class="col-12 col-lg-4">
    <div class="card border-0 shadow-sm">
        <div class="card-body p-3 d-flex align-items-center">
            ...
            <div>
                @php
                    $final_profit = $profit_amount - $expenses_amount;
                @endphp
                <div class="text-value text-primary">{{ format_currency($final_profit) }}</div>
                <div class="text-uppercase font-weight-bold small">Final Profit</div>
            </div>
        </div>
    </div>
</div>
